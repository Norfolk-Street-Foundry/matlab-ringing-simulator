...
lowndes_data.strike = strikes;
lowndes_data.info.creator = 'Genringing';

lowndes.write( lowndes_file, lowndes_data);

function writeXMLFile( xml_file, strikes, NUM_BELLS, VERSION)

SOURCE_NAME = 'RingingSim';

documentNode = strikex.build(strikes, SOURCE_NAME, SOURCE_NAME, 1);
